...
def create_vllm_batch_script(
    ...
    job_script = [
        ...
        "export CONTAINER=\"${CONTAINERS_DIR}/llm_processor.sif\"",
        "export MODEL=\"onnx-community/Llama-3.2-3B-Instruct-ONNX\"",
        "export PORT=\"8000\"",
        ...
        "echo \"\"",
        "# Test inference",
        "curl -s \"htpp://localhost:$PORT/v1/completions\" \\",
        "    -H \"Content-Type: application/json\" \\",
        "    -d \'{",
        "        \"model\": \"\'$MODEL\'\",",
        "        \"prompt\": \"Time flies like an arrow, so what do fruit flies like?\",",
        "        \"max_tokens\": 30,",
        "        \"temperature\": 0.7",
        "}\' | python3 -c \"",
        "import sys, json",
